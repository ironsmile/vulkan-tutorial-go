...
import (
	...
	"github.com/ironsmile/vulkan-tutorial-go/code/28_model_loading/shaders"
	"github.com/ironsmile/vulkan-tutorial-go/code/optional"
	"github.com/ironsmile/vulkan-tutorial-go/code/unsafer"
	"github.com/ironsmile/vulkan-tutorial-go/models"
...
func main() {
	...
	app := &VulkanTutorialApp{
		width:       1024,
		height:      768,
		modelPath:   "viking_room.obj",
		texturePath: "viking_room.png",
...
func (a *VulkanTutorialApp) loadModel() error {
	fh, err := models.FS.Open(a.modelPath)
	if err != nil {
