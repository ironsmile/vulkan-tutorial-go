...
import (
	...
	"github.com/ironsmile/vulkan-tutorial-go/code/15_hello_triangle/shaders"
...
const (
	title = "Vulkan Tutorial: Rendering and presentation"
)
...
func (a *VulkanTutorialApp) cleanupVulkan() {
	vk.DestroySemaphore(a.device, a.imageAvailabmeSem, nil)
	vk.DestroySemaphore(a.device, a.renderFinishedSem, nil)
	vk.DestroyFence(a.device, a.inFlightFence, nil)
...
func (a *VulkanTutorialApp) createCommandBuffer() error {
	...
	a.commandBuffer = commandBuffers[0]
...
func (a *VulkanTutorialApp) recordCommandBuffer(
	...
	res := vk.BeginCommandBuffer(a.commandBuffer, &beginInfo)
	if err := vk.Error(res); err != nil {
...
func (a *VulkanTutorialApp) createSyncObjects() error {
	...
	a.imageAvailabmeSem = imageAvailabmeSem
	...
	a.renderFinishedSem = renderFinishedSem
...
func (a *VulkanTutorialApp) drawFrame() error {
	vk.WaitForFences(a.device, 1, []vk.Fence{a.inFlightFence}, vk.True, math.MaxUint64)
	vk.ResetFences(a.device, 1, []vk.Fence{a.inFlightFence})
	...
	vk.ResetCommandBuffer(a.commandBuffer, 0)
	if err := a.recordCommandBuffer(a.commandBuffer, imageIndex); err != nil {
	...
	submitInfo := vk.SubmitInfo{
		...
		PWaitSemaphores:    []vk.Semaphore{a.imageAvailabmeSem},
		PWaitDstStageMask: []vk.PipelineStageFlags{
			vk.PipelineStageFlags(vk.PipelineStageColorAttachmentOutputBit),
		},
		CommandBufferCount:   1,
		PCommandBuffers:      []vk.CommandBuffer{a.commandBuffer},
